...
public class GridAdapterFavorite extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.imageView = convertView.findViewById(R.id.image_view_f);
            holder.textView = convertView.findViewById(R.id.text_view_f);
            holder.textView2 = convertView.findViewById(R.id.text_view2_f);
